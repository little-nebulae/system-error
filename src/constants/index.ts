...
export const SYSTEM_ERROR_RECORD = {
  ...
  PROCESS_INTERRUPTED_SYSTEM_ERROR: {
    code: "PROCESS_INTERRUPTED_SYSTEM_ERROR",
    errno: ERRNO_RECORD.EINTR,
  },
  OUT_OF_MEMORY_SYSTEM_ERROR: {
    code: "OUT_OF_MEMORY_SYSTEM_ERROR",
    errno: ERRNO_RECORD.ENOMEM,
  },
  ACCESS_DENIED_SYSTEM_ERROR: {
    code: "ACCESS_DENIED_SYSTEM_ERROR",
    errno: ERRNO_RECORD.EACCES,
  },
  RESOURCE_BUSY_SYSTEM_ERROR: {
    code: "RESOURCE_BUSY_SYSTEM_ERROR",
    errno: ERRNO_RECORD.EBUSY,
  },
  ...
  FILE_TOO_BIG_SYSTEM_ERROR: {
    code: "FILE_TOO_BIG_SYSTEM_ERROR",
    errno: ERRNO_RECORD.EFBIG,
  },
